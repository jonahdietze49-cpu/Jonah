...
export default function Einstellungen() {
  ...
  const handleExport = () => {
    ...
    a.href = url
    a.download = `klarblick-backup-${new Date().toISOString().slice(0, 10)}.json`
    a.click()
  ...
  const handleReset = () => {
    if (!confirm('Wirklich alle Daten in Klarblick löschen? Das kann nicht rückgängig gemacht werden.'))
      return
  ...
  return (
    <div className="space-y-6">
      <SectionTitle title="Einstellungen" subtitle="Klarblick nach deinen Wünschen" />
      ...
      <Card className="p-4 space-y-3">
        ...
        <p className="text-sm text-[var(--text-muted)]">
          Klarblick erinnert dich an fällige Aufgaben und anstehende Termine,
      ...
      <Card className="p-4 space-y-4">
        ...
        <p className="text-sm text-[var(--text-muted)]">
          Klarblick läuft als installierbare Web-App (PWA) – ein Icon auf
