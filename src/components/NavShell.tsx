...
const NAV_ITEMS: { to: string; label: string; icon: LucideIcon }[] = [
  ...
  { to: '/erinnerungen', label: 'Erinnerungen', icon: ListChecks },
    ...
    <div className="min-h-svh flex flex-col md:flex-row bg-[var(--bg)] text-[var(--text)]">
      <aside className="hidden md:flex md:w-64 md:flex-col md:border-r border-[var(--border)] p-5 gap-1 safe-top">
        <div className="flex items-center gap-2 px-2 mb-6">
          ...
          <div>
            <div className="font-semibold leading-tight">Klarblick</div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="md:hidden flex items-center gap-2 px-4 py-3 border-b border-[var(--border)] safe-top">
          ...
          <div className="font-semibold">Klarblick</div>
        </header>
        ...
        <div className="flex justify-around">
          {NAV_ITEMS.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-col items-center gap-1 py-2.5 px-2 text-[11px] font-medium flex-1 ${
